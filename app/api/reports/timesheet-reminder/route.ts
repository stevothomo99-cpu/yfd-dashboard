...
// (Sunday 21:00 UTC = Monday 07:00 AEST, QLD has no DST). Fires an hour
// after the Monday Report (06:00 AEST) so the two don't compete for the
// same XPM rate-limit budget on the one morning both run.
